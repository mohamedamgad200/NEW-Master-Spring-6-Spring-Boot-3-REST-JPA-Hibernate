...
public class AdminController {
    ...
    public ModelAndView addNewClass(@Valid @ModelAttribute("eazyClass") EazyClass eazyClass) {
    ...
    public ModelAndView displayCourses(Model model)
    {
        ...
        //find All without any sorting
        List<Courses>courses=coursesRepository.findAll();
        //Static Sorting
        //find all with ascending order
...
//        List<Courses>courses=coursesRepository.findAll(Sort.by("name").descending());
    ...
    public ModelAndView displayCourseStudents(Model model,
                                              @RequestParam int id,
                                              HttpSession session,
                                              @RequestParam(value="error",required = false) String error)
    {
